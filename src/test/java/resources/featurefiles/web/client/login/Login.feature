@ClientLogin @Regression @Web  @Recruiters @suru
Feature: Client Login Login

  @clientSuccessfulLogin @ReleaseRegression2 @ClientE2E   @WeAreTestingParallel @suru1
  ...
  @rejectClientLoginInvalid @WeAreTestingParallel @suru
